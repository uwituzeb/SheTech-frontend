...
void main() {
  ...
  testWidgets('renders lesson items', (WidgetTester tester) async {
      ...
      // Verify lesson items
      expect(find.text('Lesson 1: Introduction to Flutter'), findsOneWidget);
      expect(find.text('Lesson 2: Widgets Overview'), findsOneWidget);
    });
}
